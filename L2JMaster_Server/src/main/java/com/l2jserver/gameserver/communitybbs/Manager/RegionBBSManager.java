...
public class RegionBBSManager extends BaseBBSManager
{
	...
	{
		if (command.equals("_bbsloc") && (Config.ZEUS_ACTIVE))
		{
		...
		else if (command.startsWith("_bbsloc") && (Config.ZEUS_ACTIVE))
		{
	...
	{
		// generateList();
		ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new UpdateCommunity(), 100, 2 * 60 * 1000);
	}
