 ...
 */
public final class Q00126_TheNameOfEvil2 extends Quest
{
	// NPCs
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "32119-5b.html":
			{
				qs.playSound(Sound.ETCSOUND_ELROKI_SONG_1ST);
				break;
			}
			case "32119-5.html":
			{
			...
			case "32120-5b.html":
			{
				qs.playSound(Sound.ETCSOUND_ELROKI_SONG_2ND);
				break;
			}
			case "32120-5.html":
			{
			...
			case "32121-5b.html":
			{
				qs.playSound(Sound.ETCSOUND_ELROKI_SONG_3RD);
				break;
			}
			case "32121-5.html":
			{
			...
			case "32122-2a.html":
			{
				npc.broadcastPacket(new MagicSkillUse(npc, player, REPRESENTATION_ENTER_THE_SAILREN_NEST_QUEST, 1, 1000, 0));
				break;
			}
			case "32122-2d.html":
			{
			...
			case "32122-7.html":
			{
				qs.giveItems(BONE_POWDER, 1);
				qs.playSound(Sound.ETCSOUND_ELROKI_SONG_FULL);
				npc.broadcastPacket(new MagicSkillUse(npc, player, REPRESENTATION_ENTER_THE_SAILREN_NEST_QUEST, 1, 1000, 0));
				break;
			}
			case "32122-8.html":
			...
			case "32114-3.html":
			{
				qs.rewardItems(ENCHANT_WEAPON_A, 1);
				qs.giveAdena(460483, true);
				qs.addExpAndSp(1015973, 102802);
		...
		switch (npc.getId())
		{
			case ASAMAH:
				switch (qs.getState())
				{
					case State.CREATED:
					{
						if (talker.getLevel() < 77)
						{
							htmltext = "32115-0.htm";
						}
						else
						{
							htmltext = (talker.hasQuestCompleted(Q00125_TheNameOfEvil1.class.getSimpleName())) ? "32115-0a.htm" : "32115-0b.htm";
						}
						break;
					}
					case State.STARTED:
			...
			case WARRIORS_GRAVE:
			{
				if (qs.isStarted())
				{
					switch (qs.getCond())
					{
						...
						case 17:
						{
							htmltext = qs.hasQuestItems(BONE_POWDER) ? "32122-7.html" : "32122-7b.html";
							break;
						}
						case 18:
						{
			...
			case SHILENS_STONE_STATUE:
			{
				if (qs.isStarted())
				{
					switch (qs.getCond())
					{
						...
						case 18:
						{
							if (qs.hasQuestItems(BONE_POWDER))
							{
