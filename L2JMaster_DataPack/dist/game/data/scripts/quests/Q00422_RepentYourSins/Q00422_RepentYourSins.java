		...
		switch (event)
		{
			...
			case "30981-15t.html":
			{
				...
				if ((qs.getMemoState() >= 9) && (qs.getMemoState() <= 12) && (petLevel > qs.getMemoStateEx(1)))
				{
					...
					{
						int i0 = 0;
						if (petLevel > qs.getMemoStateEx(1))
						{
							i0 = petLevel - qs.getMemoStateEx(1) - (player.getLevel() - qs.getMemoStateEx(1));
						}
						else
						{
							i0 = petLevel - qs.getMemoStateEx(1);
						}
						...
						else
						{
							...
							player.setPkKills(player.getPkKills() - i1);
							qs.setMemoStateEx(1, 0);
						}
					}
				}
